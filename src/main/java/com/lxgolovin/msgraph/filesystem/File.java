...
import com.lxgolovin.msgraph.auth.AuthenticateInsecure;
...
public class File {
    ...
    File(IGraphServiceClient graphClient, String bucket) {
        ...
        this.bucket = bucket;
        this.graphClient = (graphClient == null) ? initGraphClient() : graphClient;
    }

    private IGraphServiceClient initGraphClient() {
        return new AuthenticateInsecure().getGraphClient();
    }

    public DriveItem getFileInfo(String file) {
